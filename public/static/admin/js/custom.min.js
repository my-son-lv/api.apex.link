$(function () {
    ...
    $(window).ready(set), $(window).on("resize", set), $(".sidebartoggler").on("click", function () {
        ...
        for (var menu = $("#menu-check").val(), element = $("ul#sidebarnav a").filter(function () {
           /* console.log(url.pathname);
            console.log(this.pathname);
            console.log(window.location);*/
           // console.log(this.innerHTML);
            /*if($.trim(this.innerHTML) === $.trim(menu)){
                console.log('aaaa');
            }*/
            return $.trim(this.innerHTML) === $.trim(menu);
        }).addClass("active").parent().addClass("active"); ;) {
            if (!element.is("li")){
                break;
            }else{
                // console.log(element.find('.active').children().text());
                $("#mbx-1").text(element.children().first().text());
                $("#mbx-2").text(element.find('.active').children().text());
            }
            // $("#mbx-1").text(this.innerHTML);
