        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <form class="form-inline" action="{{route('admin.menu.index')}}" method="get">
                                <div class="row">
                                    <div class="form-group col-lg-5 m-t-15">
                                        <label for="input" class="form-control-label col-lg-4">名称</label>
                                        <input type="text" name="name" class="form-control col-lg-8" placeholder="菜单名称"
                                               value="{{$name}}">
                                    </div>
                                    <div class="form-group col-lg-5 m-t-15">
                    ...
                    <div class="table-responsive-sm m-t-30">
                        <a type="button" class="btn btn-info m-b-15 m-t-15"  style="color: #fff;" href="{{route('admin.menu.add')}}"> 添加</a>
                        <table id="demo-foo-addrow"
                            ...
                            <tr class="footable-header">
                                ...
                                <th style="display: table-cell;">名称</th>
                                <th style="display: table-cell;">上级</th>
                                <th style="display: table-cell;">路由</th>
                                <th style="display: table-cell;">状态</th>
                                <th style="display: table-cell;">排序</th>
                            ...
                            @foreach($list as $k => $v)
                                <tr data-id="{{$v->id}}">
                                    ...
                                    <td style="display: table-cell;">{{$v->name}}</td>
                                    <td style="display: table-cell;">{{$v->route}}</td>
                                    <td style="display: table-cell;">{{$v->sort}}</td>
                                    ...
                                    <td style="display: table-cell;" class="text-center">
                                        ...
                                        @endif
                                        <a type="button" class="btn btn-info btn-xs" id="edit" style="color: #fff;" href="{{route('admin.menu.edit',['id' => $v->id])}}">
