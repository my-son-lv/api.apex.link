    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.menu.edit')}}" class="form" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" placeholder="{{$model->pname}}" onclick="showMenu();" id="pname" class="form-control" readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" name="route" placeholder="admin.user.index" class="form-control" value="{{$model->route}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label text-right">排序：</label>
                            <div class="col-8">
                                <input type="text" value="{{$model->sort}}" name="sort" placeholder="排序" id="sort" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-8 demo-radio-button" style="line-height: 38px;">
                                <input name="status" type="radio" id="radio_1" value="0"
                                       @if($model->statu == 0) checked="" @endif class="radio-col-light-blue">
                                <label for="radio_1" style="min-width: 80px;">启用</label>
                                <input name="status" type="radio" id="radio_2" value="1"
                                       @if($model->statu == 1) checked="" @endif class="radio-col-light-blue">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="offset-sm-2 col-md-8">
                                            ...
                                            <button type="submit" class="btn btn-info m-r-10"><i
