            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <form class="form-inline" action="{{route('admin.role.index')}}" method="get">
                                <div class="row">
                                    <div class="form-group col-lg-5 m-t-15">
                                        ...
                                        <input type="text" name="name" class="form-control col-lg-8" placeholder="角色名称"
                                               value="{{$name}}">
                                    </div>
                                    <div class="form-group col-lg-5 m-t-15">
                    ...
                    <div class="table-responsive-sm m-t-30">
                        <a type="button" class="btn btn-info m-b-15 m-t-15"  style="color: #fff;" href="{{route('admin.role.add')}}"> 添加</a>
                        <table id="demo-foo-addrow"
                            ...
                            <tr class="footable-header">
                                ...
                                <th style="display: table-cell;">角色名称</th>
                            ...
                            @foreach($list as $k => $v)
                                <tr data-id="{{$v->id}}">
                                    ...
                                    <td style="display: table-cell;" class="text-center">
                                        ...
                                        @endif
                                        <a type="button" class="btn btn-info btn-xs" id="edit" style="color: #fff;" href="{{route('admin.role.edit',['id' => $v->id])}}">
