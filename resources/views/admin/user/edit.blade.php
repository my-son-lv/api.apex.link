    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.user.edit')}}" class="form" method="post"  id="dataForm">
                        <input type="hidden" value="{{csrf_token()}}" name="_token">
                        <input type="hidden" value="{{$model->id}}" name="id">
                        {{--<div class="form-group row">
                            <label for="example-text-input" class="col-2 col-form-label text-right">账号：</label>
                            <div class="col-8">
                                <input type="text" name="account" id="account" placeholder="用户账号" class="form-control"
                                       value="{{$model->account}}">
                            </div>
                        </div>--}}
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input type="text" name="password" id="password" maxlength="20" placeholder="用户密码 不输入默认不修改" class="form-control"
                                       value="">
                            </div>
                        </div>
                        ...
                        {{--<div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-12" style="padding-left: 0px;">
                                    ...
                                    <input type="hidden" value="{{$model->head_img}}" id="img_id" name="img_id">
                                </div>
                            </div>
                        </div>--}}
